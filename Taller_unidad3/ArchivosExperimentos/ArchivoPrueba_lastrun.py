...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\andre\\Desktop\\Imagenes\\Gihub_andres_medina\\ImagenesMedicas\\Taller_unidad3\\ArchivoPrueba_lastrun.py',
    ...
    for thisTrial in trials:
        ...
        for thisRepeticionOn in RepeticionOn:
            ...
            while continueRoutine and routineTimer.getTime() < 0.5:
                ...
                if CondicionOff.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > CondicionOff.tStartRefresh + 0.5-frameTolerance:
                        # keep track of stop time/frame for later
